...
// ============================================================
// АПП ТОХИРГОО — "Мобайл апп (userapp-react)" модулийн харагдац
// (2026-07-30 шинэчлэв: userapp.html хуучирч, репогоос устгагдсан тул
// түүнд ЗӨВХӨН зориулагдаж байсан desktop-admin key-үүдийг хассан; харин
// userapp-react-д шинээр нэмэгдсэн resident tile-үүдийг оруулав)
// ============================================================
// userapp-react-ийн TileGrid.jsx-ийн REAL_MODULES-тэй яг тохирсон жагсаалт
// (key/label талбарууд адилхан байх ёстой)
const APP_SETTINGS_MODULES = [
  ...
  // ⚠️ Гуравдагч үйлчилгээтэй холбогдох хүлээгдэж буй placeholder tile
  // (одоогоор React талд бодит функцгүй)
  {key:'elevator',           label:'Лифт дуудах (тун удахгүй)'},
  {key:'camera',             label:'Камер харах (тун удахгүй)'},
  // ⚠️ 2026-07-30: fintax/residents/apartments/payments/reports/notifications
  // key-үүдийг хассан — эдгээр нь desktop admin (suh.html)-ийн хуудас, resident
  // (role='ot') userapp-react-д route-гүй тул үүргүй байсан. "Мэдэгдэл" (Inbox)
  // header-ийн тогтмол товч тул энд tile болгон жагсаагаагүй.
];

...
async function _computeND8Data(yearMonth) {
  ...
  const employeeRows = activeEmployees.map((e, i) => {
    ...
    return {
      ...
      // ⚠️ ИБД=ТТД=НДД (иргэний бүртгэлийн дугаар, татвар төлөгчийн дугаар, нийгмийн
      // даатгалын дэвтрийн дугаар) — гурав нь яг ижил дугаар тул давхар ашиглана.
      nd_book_number: e.registerNumber || '',

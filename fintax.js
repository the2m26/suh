...
function _renderGovReportPlaceholders() {
  ...
  // ⚠️ 2026-07-24 нэмэв: ТТ-02 таб дан ганцаараа — eTax/eBalance-той холбогдох
  // ажлын заавар (хэрэглэгчийн өгсөн баримт бичгээс). Бусад 5 таб дээрх
  // энгийн "удахгүй нэмэгдэнэ" мессежээс тусад нь, дэлгэрэнгүй заавар
  // агуулгатай тул зориулалттай функцтэй (_renderTt02Guide()).
  _renderTt02Guide();
}

function _renderTt02Guide() {
  const el = document.getElementById('gov-report-tt02');
  if (!el) return;
  el.innerHTML = `
  <div class="card" style="padding:24px;font-size:13px;line-height:1.6">
    <div style="font-weight:700;font-size:16px;margin-bottom:4px">ААНОАТТайлан (ТТ-02) — Цахим тайлангийн систем холболт</div>
    <p style="color:var(--text-muted);margin:0 0 16px">Тайлангийн загвар, дата холболт удахгүй нэмэгдэнэ. Доор — eTax/eBalance-той холбогдох ажлын заавар (лавлагаа, бүтнээрээ).</p>
    <p>СӨХ-ны менежментийн системд татварын тайланг автоматаар бэлтгэж, цахимаар илгээх (e-Filing) функц оруулах нь СӨХ-ны менежер болон нягтлан бодогчдын ажлын ачааллыг хамгийн их хөнгөвчлөх чухал шийдэл юм. СӨХ нь ашгийн бус байгууллага (төрийн бус бүтэцтэй) тул татварын системд тусгай маягт, журмаар тайлангаа тушаадаг.</p>

    <div style="font-weight:700;font-size:14.5px;margin:20px 0 4px;color:var(--accent)">A. eTax (Татвар) — developer.itc.gov.mn/docs/etax-api</div>

    <h4 style="margin:18px 0 6px">1. СӨХ-оос илгээх шаардлагатай үндсэн тайлангууд</h4>
    <table class="data-table" style="width:100%;font-size:12px;margin-bottom:14px">
      <thead><tr><th>Тайлангийн нэр / Маягт</th><th>Агуулга</th><th>Хугацаа</th></tr></thead>
      <tbody>
        <tr><td><b>ТТ-02(А)</b> — Ашгийн бус байгууллагын ААНЭОАТ</td><td>Оршин суугчдаас цуглуулсан арчлалт, ашиглалтын хураамж, бусад орлого, зарлага</td><td>Жилд 1 удаа (эсвэл улирлаар)</td></tr>
        <tr><td><b>ТТ-11</b> — Цалингийн ХХОАТ-ын тайлан</td><td>Цэвэрлэгч, харуул, сантехникч, менежер зэрэг ажилтнуудын цалингаас суутгасан татвар</td><td>Улирал бүр</td></tr>
        <tr><td><b>ТТ-12</b> — Суутган татварын тайлан</td><td>Гэрээгээр түр ажилласан хүмүүст олгосон хөлснөөс суутгасан татвар</td><td>Улирал бүр</td></tr>
      </tbody>
    </table>

    <h4 style="margin:18px 0 6px">2. Татварын тайлан цахимаар илгээх API-ийн урсгал</h4>
    <div style="background:var(--bg-card);border:1px solid var(--border);border-radius:6px;padding:10px 14px;font-family:monospace;font-size:11.5px;margin-bottom:10px;overflow-x:auto">
      [1. Өгөгдөл цуглуулах] ➔ [2. eTax Validation] ➔ [3. Цахим гарын үсэг] ➔ [4. Тайлан илгээх]<br>
      (СӨХ Системээс)&nbsp;&nbsp;&nbsp;(Загвар шалгах)&nbsp;&nbsp;&nbsp;(Monpass / GSIGN)&nbsp;&nbsp;&nbsp;(Баталгаажих)
    </div>
    <p><b>① Бэлдэц ба өгөгдөл боловсруулах:</b> тухайн улирлын орлого, зарлага, цалингийн бодолт дээр үндэслэн eTax API-ийн JSON бүтцэд хөрвүүлнэ. Хэрэглэгчид тоо баримтыг урьдчилан харуулж, гар аргаар засах боломж олгох нь зүйтэй.</p>
    <p><b>② Validation API:</b> илгээхээс өмнө eTax-ийн validate/calculate endpoint руу JSON явуулна. Систем нь маягтын томьёо, өмнөх үлдэгдэл, татварын хувь хэмжээ, логик алдааг шалгаад "Илгээхэд бэлэн" төлөв буцаана.</p>
    <p><b>③ Цахим гарын үсэг (E-Signature):</b> ТЕГ-аас Тоон гарын үсэг (Monpass, E-MonPass)-ээр заавал баталгаажуулахыг шаарддаг. Браузер дээр токен унших/E-Mongolia холбох модуль ажиллуулж, hash утгыг тайлангийн дататай нэгтгэнэ.</p>
    <p><b>④ Илгээх (Submission):</b> гарын үсгээр баталгаажсан JSON-г eTax-ийн endpoint руу илгээнэ. Хариу: Илгээсэн төлөв, Төлбөрийн нэхэмжлэх/QR код, Баталгаажсан PDF/татах линк.</p>

    <h4 style="margin:18px 0 6px">3. SPA хөгжүүлэлтийн чухал зөвлөмж (eTax)</h4>
    <ul style="margin:0 0 14px;padding-left:20px">
      <li><b>Динамик маягт:</b> ТТ-02/ТТ-11 үе үе шинэчлэгддэг тул маягтын бүтцийг eTax API-аас Schema байдлаар татаж, дэлгэцэнд динамикаар харуулбал код байнга солих шаардлагагүй.</li>
      <li><b>Тоон гарын үсгийн Token уншигч:</b> дарга/нягтлан USB Token залгаж баталгаажуулдаг тул Web PKI/Extension (Local Service холболт) нөхцөлийг бэлдэх хэрэгтэй.</li>
      <li><b>Нууцлал:</b> Цалингийн ХХОАТ тайланд ажилтнуудын регистр, овог нэр, цалин байдаг тул HTTPS болон backend дээрх өгөгдлийг өндөр нууцлалтай шифрлэх ёстой.</li>
    </ul>

    <div style="font-weight:700;font-size:14.5px;margin:24px 0 4px;color:var(--accent)">Б. eBalance (Санхүү) — developer.itc.gov.mn/docs/ebalance</div>
    <p>Сангийн яам болон Мэдээлэл технологийн төвийн (ITC) eBalance (Санхүүгийн тайлангийн цахим систем) API-тай СӨХ-ны системийг холбосноор, нягтлан бодогч эсвэл менежер жилийн болон хагас жилийн санхүүгийн тайлангаа ebalance.mof.gov.mn систем рүү шууд дамжуулах боломжтой болно. eTax-тай адил, eBalance систем нь Нэвтрэлтийн нэгдсэн систем (SSO / OAuth2) болон Тоон гарын үсэг дээр үндэслэн ажилладаг.</p>

    <div style="background:rgba(245,158,11,0.1);border:1px solid var(--warning);border-radius:6px;padding:10px 14px;margin:10px 0 14px">
      <b>⚠️ Архитектурын санамж (SPA + Backend):</b> eBalance интеграцид нэвтрэлтийн OAuth2 токен, нууц код (Client Secret) болон санхүүгийн мэдээлэл дамждаг тул <b>SPA (Frontend)-ээс шууд БИШ, Backend серверээр дамжуулан</b> холболт хийнэ:
      <div style="font-family:monospace;font-size:11px;margin-top:6px">[SPA Frontend] ──(HTTPS)──➔ [СӨХ Backend Сервер] ──(OAuth2/API Key)──➔ [eBalance API]<br>(React/Vue UI)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Node/Python/C#)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(ebalance.mof.gov.mn)</div>
    </div>

    <h4 style="margin:18px 0 6px">4. eBalance API холболтын 4 үндсэн шат</h4>
    <p><b>Шат 1 — Нэвтрэлтийн нэгдсэн систем (SSO Auth Integration):</b> Хэрэглэгч нэвтрэх урсгал:</p>
    <ol style="margin:0 0 12px;padding-left:22px">
      <li>СӨХ-ны нягтлан SPA дээр "eBalance-аар нэвтрэх" эсвэл "Санхүүгийн тайлан илгээх" товчлуур дээр дарна.</li>
      <li>Браузер Сангийн яамны SSO нэвтрэх хуудас руу чиглэнэ (Redirect).</li>
      <li>Нягтлан өөрийн eBalance нэвтрэх эрх/тоон гарын үсгээр нэвтэрсний дараа Backend рүү Authorization Code буцаж ирнэ.</li>
      <li>Backend сервер уг кодыг ашиглан Access Token ба Refresh Token авч, тухайн СӨХ-ны eBalance дээрх эрхийг баталгаажуулна.</li>
    </ol>

    <p><b>Шат 2 — СӨХ-ны Санхүүгийн Тайлангийн Бүтэц (Data Schema):</b> СӨХ (Ашгийн бус байгууллага, ТББ)-ийн НББ стандартын дагуу дараах 4 үндсэн тайланг eBalance руу илгээдэг:</p>
    <table class="data-table" style="width:100%;font-size:12px;margin-bottom:14px">
      <thead><tr><th>Тайлангийн нэр</th><th>Заавал илгээх эсэх</th><th>Агуулга</th></tr></thead>
      <tbody>
        <tr><td><b>Баланс</b> (Санхүүгийн байдлын тайлан)</td><td>Заавал</td><td>Хөрөнгө, Өр төлбөр, Цэвэр хөрөнгийн үлдэгдэл</td></tr>
        <tr><td><b>Орлого, үр дүнгийн тайлан</b></td><td>Заавал</td><td>Гишүүдийн орлого (хураамж), үйл ажиллагааны ба бусад зардал</td></tr>
        <tr><td><b>Мөнгөн гүйлгээний тайлан</b></td><td>Заавал</td><td>Үйл ажиллагаа, хөрөнгө оруулалтын мөнгөн орлого/зарлага</td></tr>
        <tr><td><b>Цэвэр хөрөнгийн өөрчлөлтийн тайлан</b></td><td>СӨХ-ийн бүтцээс хамаарна</td><td>Хуримтлагдсан ашиг/алдагдал, фондын өөрчлөлт</td></tr>
        <tr><td><b>Санхүүгийн тайлангийн тодруулга</b></td><td>Заавал</td><td>Текст болон дэлгэрэнгүй хүснэгэн тайлбарууд</td></tr>
      </tbody>
    </table>

    <p><b>Шат 3 — Тайлан шалгах & Илгээх API урсгал:</b></p>
    <div style="background:var(--bg-card);border:1px solid var(--border);border-radius:6px;padding:10px 14px;font-family:monospace;font-size:11.5px;margin-bottom:10px;overflow-x:auto">
      [1. Draft create] ➔ [2. Fill Data] ➔ [3. Validate] ➔ [4. Digital Sign] ➔ [5. Submit]<br>
      (Шинэ тайлан үүсгэх)&nbsp;(Дата оруулах)&nbsp;(Тайлан шалгах)&nbsp;(Тоон гарын үсэг)&nbsp;(Албан ёсоор тушаах)
    </div>
    <ol style="margin:0 0 12px;padding-left:22px">
      <li><b>Тайлангийн төсөл үүсгэх (Create Draft):</b> тухайн тайлант хугацаа (жиш нь 2026 оны 1-р хагас жил)-ны ID-г авч шинэ draft үүсгэнэ.</li>
      <li><b>Өгөгдөл илгээх (Save Report Data):</b> СӨХ-ны системийн ерөнхий журнал болон тайлангийн дүн мэдээг eBalance API-ийн JSON стандартаар хэсэгчлэн болон бүтнээр нь илгээнэ.</li>
      <li><b>Логик болон баланс шалгах (Validate):</b> "Хөрөнгө = Өр төлбөр + Цэвэр хөрөнгө" адилтгал зөв байгаа эсэх, эхний үлдэгдэл болон эцсийн үлдэгдлийн зөрүүг eBalance сервер автоматаар шалгаад алдаатай бол алдааны мэдээлэл буцаана.</li>
      <li><b>Тоон гарын үсгээр баталгаажуулах (E-Sign):</b> СӨХ-ны дарга болон Нягтлан бодогч 2 сувгаар тоон гарын үсгээ (Monpass эсвэл GSIGN) зурах шаардлагатай байдаг.</li>
      <li><b>Тайлан эцэслэн тушаах (Final Submit):</b> баталгаажсан тайланг eBalance системд албан ёсоор тушааж, Хүлээн авсан штамп бүхий PDF/Баталгаажуулалт буцаан авна.</li>
    </ol>

    <p><b>Шат 4 — SPA дээр анхаарах UX/UI зөвлөмж (eBalance):</b></p>
    <ul style="margin:0 0 14px;padding-left:20px">
      <li><b>Дэлгэц дээрх Балансын хүснэгт (Grid View):</b> eBalance руу шууд тушаахаас өмнө SPA дээр санхүүгийн тайлангийн багануудыг яг Сангийн яамны СТ-1, СТ-2 маягттай ижил бүтцээр харуулж, нягтлан тулгах боломжоор хангах.</li>
      <li><b>Алдааны мэдээллийг тодорхой харуулах:</b> API-аас Validate хийхэд ирэх алдаа (жиш нь "Мөнгөн гүйлгээний эцсийн үлдэгдэл Балансын мөнгөн хөрөнгөтэй таарахгүй байна") гарвал, SPA дээр аль мөр, аль багана дээр зөрүү гарсныг тод зааж өгөх.</li>
      <li><b>Хоёр талт гарын үсэг зурах интерфэйс:</b> Дарга болон Нягтлан 2 өөр хүн гарын үсэг зурдаг тул "Нягтлан зурсан / Дарга зурахыг хүлээж буй" гэсэн төлвийг харуулах.</li>
    </ul>

    <div style="font-weight:700;font-size:14.5px;margin:24px 0 4px;color:var(--accent)">В. Харьцуулалт ба жишээ JSON</div>
    <h4 style="margin:18px 0 6px">5. eTax vs eBalance — бүтцийн ялгаа</h4>
    <table class="data-table" style="width:100%;font-size:12px;margin-bottom:14px">
      <thead><tr><th>Үзүүлэлт</th><th>eTax (Татвар)</th><th>eBalance (Санхүү)</th></tr></thead>
      <tbody>
        <tr><td>Тайлант хугацааны код (period_type)</td><td>Q1, Q2, Q3, Q4 (улирлаар)</td><td>H1 (хагас жил), FY (бүтэн жил)</td></tr>
        <tr><td>Маягтын код (form_code)</td><td>TT-02A, TT-11, TT-12</td><td>ST-1, ST-2, ST-3 (Сангийн яамны стандарт)</td></tr>
        <tr><td>Тоон гарын үсэг</td><td>Ганц Base64 hash</td><td>Нягтлан + Захирал — 2 давхар гарын үсэг</td></tr>
        <tr><td>Шалгалтын логик (Validation)</td><td>Татварын хөнгөлөлт, чөлөөлөлт, хувь хэмжээ</td><td>Хөрөнгө = Өр төлбөр + Цэвэр хөрөнгө адилтгал</td></tr>
      </tbody>
    </table>

    <h4 style="margin:18px 0 6px">6a. eTax API — жишээ JSON (АШБТТ-02)</h4>
    <pre style="background:var(--bg-card);border:1px solid var(--border);border-radius:6px;padding:12px;font-size:11px;overflow-x:auto;margin:0 0 14px">{
  "system": "eTax",
  "header": {
    "regno": "1234567", "tin": "123456701",
    "period_year": 2026, "period_type": "Q2",
    "form_code": "TT-02A", "branch_code": "01",
    "created_at": "2026-07-24T01:00:00Z"
  },
  "auth_and_signature": {
    "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6...",
    "signed_data": "BASE64_ENCODED_MONPASS_SIGNATURE_STRING",
    "certificate_serial": "567A89B0123"
  },
  "data": {
    "income_section": {
      "member_dues_income": 15000000.00,
      "service_income": 1200000.00,
      "total_gross_income": 16200000.00
    },
    "expense_section": {
      "operating_expense": 11000000.00,
      "maintenance_expense": 3500000.00,
      "salary_expense": 1500000.00,
      "total_deductible_expense": 16000000.00
    },
    "tax_calculation": {
    ...
    <h4 style="margin:18px 0 6px">6б. eBalance API — жишээ JSON (Баланс СТ-1)</h4>
    <pre style="background:var(--bg-card);border:1px solid var(--border);border-radius:6px;padding:12px;font-size:11px;overflow-x:auto;margin:0 0 6px">{
  "system": "eBalance",
  "header": {
    "regno": "1234567", "tin": "123456701",
    "period_year": 2026, "period_type": "H1",
    "form_code": "ST-1", "org_type": "SOKH_NGO",
    "created_at": "2026-07-24T01:00:00Z"
  },
  "auth_and_signature": {
    "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6...",
  ...
  "data": {
    "assets_section": {
      "cash_and_bank_balances": 4500000.00,
      "accounts_receivable": 1800000.00,
      "total_current_assets": 6300000.00,
      "property_and_equipment": 12000000.00,
      "total_assets": 18300000.00
    },
    "liabilities_and_equity_section": {
      "short_term_payables": 800000.00,
      "total_liabilities": 800000.00,
      "accumulated_fund_balance": 17500000.00,
      "total_liabilities_and_equity": 18300000.00
    }
  }
}</pre>
    <p style="font-size:11px;color:var(--text-muted)">Эх сурвалж: developer.itc.gov.mn/docs/etax-api, developer.itc.gov.mn/docs/ebalance.</p>
  </div>`;
}
...
const APP_SETTINGS_MODULES = [
  ...
  // ⚠️ 2026-07-27: Хуучин загварын, userapp.html-д бодитоор ажилладаг тайлууд
  // — устгаагvй, зvгээр л шинэ 8 гол тайлын дараа vлдээв.
  {key:'residents',     label:'Сууц өмчлөгчийн бvртгэл'},
...
// ============================================================
// АПП ТОХИРГОО — ТАБ СЭЛГЭХ (2026-07-29 нэмэв)
// ============================================================
function switchAppSettingsTab(name, el) {
  document.querySelectorAll('#app-settings-tabs .tab').forEach(t => t.classList.remove('active'));
  el.classList.add('active');
  document.getElementById('app-settings-tab-modules').style.display = name === 'modules' ? '' : 'none';
  document.getElementById('app-settings-tab-call-service').style.display = name === 'call-service' ? '' : 'none';
  document.getElementById('app-settings-tab-emergency').style.display = name === 'emergency' ? '' : 'none';
}

// ============================================================
// ТӨЛБӨРТ ҮЙЛЧИЛГЭЭ — CRUD (local_services хүснэгэл, userapp-react-ийн
// "Төлбөрт үйлчилгээ" tile-д ашиглагдана)
// ============================================================
let _callServiceRows = [];
async function loadCallServiceList() {
  const { data, error } = await sb.from('local_services').select('*').order('order_num');
  if (error) { toast('Ачаалахад алдаа гарлаа: ' + error.message, 'error'); return; }
  _callServiceRows = data || [];
  renderCallServiceList();
}
function renderCallServiceList() {
  const body = document.getElementById('call-service-list-body');
  if (!body) return;
  body.innerHTML = _callServiceRows.map(r => `
    <tr data-id="${r.id}">
      <td><input type="text" value="${esc(r.category || '')}" data-field="category" style="width:100%"></td>
      <td><input type="text" value="${esc(r.phone || '')}" data-field="phone" style="width:100%"></td>
      <td><input type="text" value="${esc(r.telegram || '')}" data-field="telegram" style="width:100%"></td>
      <td><input type="text" value="${esc(r.viber || '')}" data-field="viber" style="width:100%"></td>
      <td style="white-space:nowrap">
        <button class="btn btn-sm btn-outline" onclick="saveCallServiceRow('${r.id}')">Хадгалах</button>
        <button class="btn btn-sm btn-danger" onclick="deleteCallServiceRow('${r.id}')">Устгах</button>
      </td>
    </tr>`).join('');
}
function addCallServiceRow() {
  const maxOrder = _callServiceRows.reduce((m, r) => Math.max(m, r.order_num || 0), 0);
  _callServiceRows.push({ id: 'new-' + Date.now(), category: '', phone: '', telegram: '', viber: '', order_num: maxOrder + 1 });
  renderCallServiceList();
}
async function saveCallServiceRow(id) {
  const tr = document.querySelector(`#call-service-list-body tr[data-id="${id}"]`);
  if (!tr) return;
  const row = { category: tr.querySelector('[data-field="category"]').value.trim(), phone: tr.querySelector('[data-field="phone"]').value.trim(),
    telegram: tr.querySelector('[data-field="telegram"]').value.trim(), viber: tr.querySelector('[data-field="viber"]').value.trim() };
  if (!row.category) { toast('Категори нэрийг бөглөнө үү', 'error'); return; }
  let error;
  if (String(id).startsWith('new-')) {
    ({ error } = await sb.from('local_services').insert(row));
  } else {
    ({ error } = await sb.from('local_services').update(row).eq('id', id));
  }
  if (error) { toast('Хадгалахад алдаа гарлаа: ' + error.message, 'error'); return; }
  logActivity('edit', 'app-settings', null, `Төлбөрт үйлчилгээ: ${row.category}`);
  toast('Хадгалагдлаа ✓', 'success');
  await loadCallServiceList();
}
async function deleteCallServiceRow(id) {
  if (String(id).startsWith('new-')) { _callServiceRows = _callServiceRows.filter(r => r.id !== id); renderCallServiceList(); return; }
  if (!confirm('Энэ мөрийг устгах уу?')) return;
  const { error } = await sb.from('local_services').delete().eq('id', id);
  if (error) { toast('Устгахад алдаа гарлаа: ' + error.message, 'error'); return; }
  logActivity('delete', 'app-settings', null, 'Төлбөрт үйлчилгээний мөр устгав');
  await loadCallServiceList();
}

// ============================================================
// ОНЦГОЙ ХЭРЭГЦЭЭТ УТАСНЫ ДУГААРУУД — CRUD (emergency_contacts хүснэгэл,
// userapp-react-ийн адил нэртэй tile-д ашиглагдана)
// ============================================================
let _emergencyContactRows = [];
async function loadEmergencyContactsList() {
  const { data, error } = await sb.from('emergency_contacts').select('*').order('order_num');
  if (error) { toast('Ачаалахад алдаа гарлаа: ' + error.message, 'error'); return; }
  _emergencyContactRows = data || [];
  renderEmergencyContactsList();
}
function renderEmergencyContactsList() {
  const body = document.getElementById('emergency-contacts-list-body');
  if (!body) return;
  body.innerHTML = _emergencyContactRows.map(r => `
    <tr data-id="${r.id}">
      <td><input type="text" value="${esc(r.name || '')}" data-field="name" style="width:100%"></td>
      <td><input type="text" value="${esc(r.phone || '')}" data-field="phone" style="width:100%"></td>
      <td style="white-space:nowrap">
        <button class="btn btn-sm btn-outline" onclick="saveEmergencyContactRow('${r.id}')">Хадгалах</button>
        <button class="btn btn-sm btn-danger" onclick="deleteEmergencyContactRow('${r.id}')">Устгах</button>
      </td>
    </tr>`).join('');
}
function addEmergencyContactRow() {
  const maxOrder = _emergencyContactRows.reduce((m, r) => Math.max(m, r.order_num || 0), 0);
  _emergencyContactRows.push({ id: 'new-' + Date.now(), name: '', phone: '', order_num: maxOrder + 1 });
  renderEmergencyContactsList();
}
async function saveEmergencyContactRow(id) {
  const tr = document.querySelector(`#emergency-contacts-list-body tr[data-id="${id}"]`);
  if (!tr) return;
  const row = { name: tr.querySelector('[data-field="name"]').value.trim(), phone: tr.querySelector('[data-field="phone"]').value.trim() };
  if (!row.name || !row.phone) { toast('Нэр, утас хоёуланг нь бөглөнө үү', 'error'); return; }
  let error;
  if (String(id).startsWith('new-')) {
    ({ error } = await sb.from('emergency_contacts').insert(row));
  } else {
    ({ error } = await sb.from('emergency_contacts').update(row).eq('id', id));
  }
  if (error) { toast('Хадгалахад алдаа гарлаа: ' + error.message, 'error'); return; }
  logActivity('edit', 'app-settings', null, `Онцгой утас: ${row.name}`);
  toast('Хадгалагдлаа ✓', 'success');
  await loadEmergencyContactsList();
}
async function deleteEmergencyContactRow(id) {
  if (String(id).startsWith('new-')) { _emergencyContactRows = _emergencyContactRows.filter(r => r.id !== id); renderEmergencyContactsList(); return; }
  if (!confirm('Энэ мөрийг устгах уу?')) return;
  const { error } = await sb.from('emergency_contacts').delete().eq('id', id);
  if (error) { toast('Устгахад алдаа гарлаа: ' + error.message, 'error'); return; }
  logActivity('delete', 'app-settings', null, 'Онцгой утасны мөр устгав');
  await loadEmergencyContactsList();
}

// ============================================================
// ИРСЭН САНАЛ, ХүСЭЛТ — жагсаалт (feedback_requests, userapp-react-ийн
// "СӨХ-д санал хүсэлт илгээх" tile-аас ирнэ). "Зар мэдэгдэл илгээх" →
// "Илгээсэн" табтай ЯГ ИЖИЛ дизайн/шүүлтүүр/хайлтын логик.
// ============================================================
let _callLogAll = [];
function _fmtCallLogDateTime(iso) {
...
function _populateCallLogYearOptions() {
  const sel = document.getElementById('calllog-year-filter');
  if (!sel) return;
  const years = [...new Set(_callLogAll.filter(r=>r.created_at).map(r=>+r.created_at.slice(0,4)))].sort((a,b)=>b-a);
...
function _populateCallLogDayOptions() {
  const el = document.getElementById('calllog-day-filter');
...
async function loadCallLogInbox() {
  const body = document.getElementById('call-log-inbox-body');
  if (!body) return;
  if (!_callLogAll.length) {
    const { data, error } = await sb.from('feedback_requests').select('*').order('created_at', { ascending: false });
    if (error) { body.innerHTML = `<div class="empty-state">Ачаалахад алдаа гарлаа: ${esc(error.message)}</div>`; return; }
    _callLogAll = data || [];
  }
  _populateCallLogYearOptions();
  _populateCallLogDayOptions();

  const yf = document.getElementById('calllog-year-filter')?.value || '';
  const mf = document.getElementById('calllog-month-filter')?.value || '';
  const df = document.getElementById('calllog-day-filter')?.value || '';
  const sf = document.getElementById('calllog-status-filter')?.value || '';
  const q = (document.getElementById('calllog-search')?.value || '').trim().toLowerCase();

  const list = _callLogAll.filter(r => {
  ...
  if (!list.length) { body.innerHTML = '<div class="empty-state">Одоогоор ирсэн санал, хүсэлт алга</div>'; return; }
  body.innerHTML = `<table class="data-table">
    <thead><tr><th>Хугацаа</th><th>Тоот</th><th>Илгээгч</th><th>Агуулга</th><th>Төlөв</th></tr></thead>
    <tbody>${list.map(r => {
      const isNew = r.status === 'new';
      return `
      <tr data-id="${r.id}">
        <td class="dt-mono">${esc(_fmtCallLogDateTime(r.created_at))}</td>
        <td class="dt-text">${esc(String(r.apt))}</td>
        <td class="dt-muted">${esc(r.sender_name || '')}</td>
        <td class="dt-muted" style="max-width:360px;white-space:pre-wrap">${esc(r.content || '')}</td>
        <td>
          <button class="btn btn-sm ${isNew ? 'btn-primary' : 'btn-outline'}" onclick="toggleCallLogStatus(${r.id}, '${isNew ? 'reviewed' : 'new'}')">
            ${isNew ? 'Шинэ' : 'Хянасан'}
          </button>
        </td>
      </tr>`;
...
async function toggleCallLogStatus(id, newStatus) {
  const { error } = await sb.from('feedback_requests').update({ status: newStatus }).eq('id', id);
  if (error) { toast('Шинэчлэхэд алдаа гарлаа: ' + error.message, 'error'); return; }
  _callLogAll = []; // кэш хүчингүй болгож, дахин татна
  await loadCallLogInbox();
  await updateCallLogBadge();
}
// ============================================================
// ИРСЭН САНАЛ, ХүСЭЛТ — sidebar badge (Төlбор төlölт-ийн overdue-badge-тэй
// ЯГ ИЖИЛ загвар)
// ============================================================
async function updateCallLogBadge() {
  const { count, error } = await sb.from('feedback_requests').select('id', { count: 'exact', head: true }).eq('status', 'new');
  const badge = document.getElementById('call-log-badge');

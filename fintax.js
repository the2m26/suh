...
function _renderTt02Guide() {
  ...
  <div class="card" style="padding:24px;font-size:13px;line-height:1.6">
    ...
    <p style="color:var(--text-muted);margin:0 0 16px">Тайлангийн загвар, дата холболт удахгүй нэмэгдэнэ. Доор — eTax/eBalance-той холбогдох ажлын заавар (лавлагаа).</p>
    ...
    <h4 style="margin:18px 0 6px">3. SPA хөгжүүлэлтийн чухал зөвлөмж</h4>
    ...
    <h4 style="margin:18px 0 6px">4. eTax vs eBalance — бүтцийн ялгаа</h4>
    <table class="data-table" style="width:100%;font-size:12px;margin-bottom:14px">
    ...
    <h4 style="margin:18px 0 6px">5. eTax API — жишээ JSON (АШБТТ-02)</h4>
  ...
  "data": {
    ...
    <p style="font-size:11px;color:var(--text-muted)">Эх сурвалж: developer.itc.gov.mn/docs/etax-api. eBalance (Санхүү, А/Б маягт)-ийн тэнцүү заавар — ижил баримт бичигт, хүсвэл тусад нь нэмж үзүүлж болно.</p>
  </div>`;
}

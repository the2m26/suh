...
<td style="text-align:left;vertical-align:middle;" class="">Дарга/захирал: ${data.director_name} ........................... /…………………/<br>	 	 (гарын үсэг) 	 (нэр)<br><br>Нягтлан бодогч: ${data.accountant_name} ........................... /…………………/<br>	 	 (гарын үсэг) 	 (нэр)</td>
...
// Хэвлэхээс өмнө browser бодитоор шинэ HTML-г layout хийж дуусахыг хvлээнэ —
// зvгээр нэг setTimeout нь заримдаа хангалттай биш (хvснэгэл олон, том агуулга
// vед) тул давхар requestAnimationFrame ашиглаж, "дараагийн 2 frame" хvртэл
// хvлээснээр browser-ийн layout/paint бодитоор дуусахыг баталгаажуулна.
...
function printActiveGovReport() {
  if (_activeGovReportTab() === 'nd8') printND8(); else printND7();
}

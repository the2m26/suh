...
async function _renderND7() {
  ...
  el.innerHTML = `<div class="nd-report-root" style="background:#fff;padding:20px;border-radius:8px;overflow-x:auto">${_renderND7PrintForm(d)}</div>`;
}
...
async function _renderND8() {
  ...
  el.innerHTML = `<div class="nd-report-root" style="background:#fff;padding:20px;border-radius:8px;overflow-x:auto">${_renderND8PrintForm(d)}</div>`;
}

...
const NEWS_EDITOR_COLORS = ['#3B82F6', '#10B981', '#F59E0B', '#EF4444', '#8B5CF6', '#EC4899'];
...
async function renderNewsEditorPage() {
  ...
  // ⚠️ 2026-07-24 засав: Огнооны багана хамгийн зүүн (эхний) багана болов;
  // Засах/Устгах товчийг Сууц өмчлөгч/ААН бүртгэлтэй ЯГ ИЖИЛ svg дүрсээр
  // (харандаа=засах, хогийн сав=устгах) сольсон; мөр дээр дарахад ч мөн засах
  // хуудас руу шууд орно (dt-* классуудыг ашиглаж, глобал хүснэгэлийн загвартай нийцүүлэв).
  el.innerHTML = `<table class="data-table">
    <thead><tr><th>Огноо</th><th>Гарчиг</th><th>Төлөв</th><th>Онцлох</th><th>Шуурхай</th><th>Паблик</th><th></th></tr></thead>
    <tbody>${data.map(p => `

...
function renderCCThreadList() {
  ...
  container.innerHTML = list.map(t => {
    ...
    //   Muted  → avatar дотор инициаль үсгийн дээр саарал mute SVG icon давхарлана
    const avatarBorder = st.urgent ? 'border:2px solid var(--danger)' : 'border:1px solid var(--border-light)';
    const muteIcon = st.muted ? `
      <div title="Muted" style="position:absolute;inset:0;border-radius:50%;background:rgba(11,26,46,0.72);display:flex;align-items:center;justify-content:center">

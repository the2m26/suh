...
function calcRentPreview() {
  rentSettings.perSqm = _numField('rent-per-sqm', 15000);
  rentSettings.garage = _numField('rent-garage', 25000);
  rentSettings.storageSqm = _numField('rent-storage', 1500);
  rentSettings.waste = _numField('rent-waste', 50000);
  rentSettings.extra = _numField('rent-extra', 0);
  ...
  const units = _numField('rent-preview-units', 1);
...
function calcFeePreview() {
  feeSettings.perSqm=_numField('fee-per-sqm', 2500);
  feeSettings.utility=_numField('fee-utility', 15000);
  feeSettings.garage=_numField('fee-garage', 25000);
  feeSettings.storageSqm=_numField('fee-storage', 1500);

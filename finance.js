...
function calcRentPreview() {
  ...
  // Зогсоол/Агуулах мөр тус бvр ӨӨРИЙН object_type-ээрээ (parking/storage)
  // тодорхойлогдоно — Тарифын каталогт тухайн vед идэвхтэй Тооцооллын аргаас
  // (м²/ширхэг) vл хамааран, оролтын 2 талбар (garages, stSqm) ХЭЗЭЭ Ч
  // хооронд солигдохгvй (parking мөр vргэлж garages, storage мөр vргэлж stSqm).
...
function calcFeePreview() {
  ...
  // Зогсоол/Агуулах мөр тус бvр ӨӨРИЙН object_type-ээрээ (parking/storage)
  // тодорхойлогдоно — 2 оролтын талбар хооронд ХЭЗЭЭ Ч солигдохгvй.

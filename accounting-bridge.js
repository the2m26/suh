...
// ------------------------------------------------------------
// НЭХЭМЖЛЭЛ ЖУРНАЛД БүРТГЭХ (Нягтлан бодох бүртгэл → "Нэхэмжлэл журналд бүртгэх" tab).
...
async function recordMonthlyInvoice(auto) {
  ...
  const summary = `${succeeded} бүртгэгдлээ` + (skipped ? `, ${skipped} өмнө нь бүртгэгдсэн байсан` : '') + (failed ? `, ${failed} алдаатай (Console үзнэ vv)` : '');
  ...
  // журналд бүртгэх" (энд) ба "Нэхэмжлэл илгээх" одоо 2 ТУСДАА, өөр өөр календарийн
